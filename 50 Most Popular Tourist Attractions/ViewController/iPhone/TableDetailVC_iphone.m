...
@implementation TableDetailVC_iphone
...
{	
	if(FavFlag == 1)
	{
		...
		if ([Database executeScalarQuery:strUpdateQuery])
		{
            ...
            TableVC_iphone *obj_vc =[[ TableVC_iphone alloc] initWithNibName:@"TableVC_iphone" bundle:nil];
            obj_vc.fav_check = 1;
            [obj_vc release];
            FavFlag = 0;
...
{   
 ...
 // [self HideBar];
  //  [self ShowBar];
    ...
    scroll.frame = CGRectMake(0, 30, 320, 450);
