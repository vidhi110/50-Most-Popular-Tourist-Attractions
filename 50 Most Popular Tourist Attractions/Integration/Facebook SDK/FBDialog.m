...
#import "FBDialog.h"
#import "Facebook.h"
//#import "Dianasur_ReferenceAppDelegate_iPad.h"
#import "TableDetailVC_iphone.h"
#import "FavDetailVC.h"
//#import "Table_VC_ipad.h"
///////////////////////////////////////////////////////////////////////////////////////////////////
// global
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
  ...
  //new Napkin - requesting credentials - display dialog
  [self performSelector:@selector(dialogRequestingCredentials) withObject:nil afterDelay:1.0];
}

- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Error" message:@"Network Not reachable" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
    [alert show];
    [alert release];
